  ...
  return (
    <div className="h-full flex flex-col">
      ...
      {showAddForm && !editingId && (
        <div className="flex-shrink-0 bg-dark-surface rounded border border-dark-border p-2.5 mb-2">
          <div className="space-y-2.5">
            <div>
              ...
              <div className="flex gap-1.5">
                <input
                  ...
                  className="flex-1 px-2 py-1.5 bg-dark-bg border border-dark-border rounded text-text-primary text-xs font-mono placeholder-text-muted focus:outline-none focus:border-accent-blue/50"
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-2 py-1.5 bg-dark-bg border border-dark-border rounded text-text-primary text-xs placeholder-text-muted focus:outline-none focus:border-accent-blue/50"
              />
            </div>
          ...
          folders.map((folder) => {
            ...
            return (
              ...
              >
                ...
                {/* Inline edit form */}
                {isEditing && (
                  <div className="bg-dark-bg/50 border-t border-dark-border px-2.5 py-2.5 space-y-2.5">
                    <div>
                      <label className="block text-text-secondary text-xs font-medium mb-1 uppercase tracking-wider">
                        Folder Path
                      </label>
                      <div className="flex gap-1.5">
                        <input
                          ...
                          value={formPath}
                          onChange={(e) => setFormPath(e.target.value)}
                          className="flex-1 px-2 py-1.5 bg-dark-surface border border-dark-border rounded text-text-primary text-xs font-mono placeholder-text-muted focus:outline-none focus:border-accent-blue/50"
                        />
                        <button
                          type="button"
                          onClick={handleBrowse}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={formName}
                        onChange={(e) => setFormName(e.target.value)}
                        className="w-full px-2 py-1.5 bg-dark-surface border border-dark-border rounded text-text-primary text-xs placeholder-text-muted focus:outline-none focus:border-accent-blue/50"
                      />
                    </div>
