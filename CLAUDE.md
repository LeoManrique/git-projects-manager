...
- ./FRONTEND.md with the behavior of the frontend apps. Any change applied to the SwiftUI app (macos/) should be documented and also be applied to Tauri app (desktop/) and viceversa. FRONTEND.md stays as the source of truth of what the frontend apps do.
...
Prefer using justfile commands over raw commands. Feel free to suggest new commands to the user if you think they are useful.
