...
changes, unpushed/unpulled commits, never-published (no-remote) projects, repos whose
remote was deleted on the host, and forgotten uninitialized directories — from one
dashboard.
